    ...
    return (
        <div className={containerClasses} ref={containerRef}>
            <div className={cl.mineMarketItems__container__block}>
                ...
                <div className={cl.mineMarketItems__container__block__content}>
                    <div className={cl.mineMarketItems__container__block__content__title}>
                        {item.title}
                    </div>
                    <div className={cl.mineMarketItems__container__block__content__profitText}>
                        Profit per hour
                    </div>
                    <div className={cl.mineMarketItems__container__block__content__profit}>
                        <div className={cl.mineMarketItems__container__block__image}>

                            <CoinIcon height={'13px'} width={'13px'} />

                        </div>
                        +{convertMoneyToReduction(item.profit)}
                    </div>
                </div>
            </div>
